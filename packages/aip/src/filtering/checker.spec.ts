...
import type { ParsedExpr } from "@buf/googleapis_googleapis.bufbuild_es/google/api/expr/v1alpha1/syntax_pb.js";
import { createMutableRegistry, type DescMessage, isMessage } from "@bufbuild/protobuf";
import {
...
describe("Checker", () => {
  const testCases: {
    ...
    },
    {
      ...
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("a", TypeInt)],
    },
    {
      filter: "NOT (a OR b)",
      declarations: [
    ...
    {
      filter: `-file:".java"`,
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("file", TypeString)],
    },
    {
      filter: "-30",
    ...
    {
      filter: `msg != 'hello'`,
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("msg", TypeString)],
    },
    {
      filter: `1 > 0`,
    ...
    {
      filter: `foo >= -2.4`,
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("foo", TypeFloat)],
    },
    {
      filter: `foo >= (-2.4)`,
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("foo", TypeFloat)],
    ...
    },
    {
      ...
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("retries", TypeInt)],
    ...
    },
    {
      ...
      declarations: [
        ...
        newFunctionDeclaration(
          "endsWith",
          newFunctionOverload("endsWith_string", TypeBool, TypeString, TypeString),
        ),
    ...
    },
    {
      ...
      declarations: [
        ...standardFunctionDeclarations(),
        newFunctionDeclaration("time.now", newFunctionOverload("time.now", TypeTimestamp)),
    ...
    },
    {
      ...
      declarations: [...standardFunctionDeclarations(), newIdentDeclaration("ttl", TypeDuration)],
    },
    {
  ...
  for (const testCase of testCases) {
    it(`should check ${testCase.filter}`, () => {
      ...
      if (parsed instanceof Error) {
        expect(drillDownOnErrorMessage(parsed)).toContain(testCase.errorContains);
        return;
      }
      ...
      if (checked instanceof Error) {
        expect(drillDownOnErrorMessage(checked)).toContain(testCase.errorContains);
        return;
      }
