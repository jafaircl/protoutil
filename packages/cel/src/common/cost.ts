...
/**
 * StringTraversalCostFactor is multiplied by a string length when traversing the entire string once.
 */
export const StringTraversalCostFactor = 0.1;

/**
 * RegexStringLengthCostFactor is multiplied by a regex pattern length when applying the regex to a
 * string of unit cost.
 */
