...
describe('Unknown', () => {
  ...
  it('AttributeTrail toString', () => {
    const tests = [
      ...
      {
        attr: qualifyAttribute(qualifyAttribute(new AttributeTrail('a'), 'b'), '$this'),
        out: 'a.b["$this"]',
      },
      {
  ...
  it('Unknown contains', () => {
    const tests = [
      ...
      {
        unk: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), true)),
        other: new UnknownRefVal(BigInt(4), qualifyAttribute(new AttributeTrail('a'), 'b')),
        out: false,
      },
      {
        unk: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 'b')),
        other: new UnknownRefVal(BigInt(4), qualifyAttribute(new AttributeTrail('a'), 'b')),
        out: false,
      },
      {
        unk: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 'c')),
        other: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 'b')),
        out: false,
      },
      {
        unk: mergeUnknowns(
          new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), true)),
          new UnknownRefVal(BigInt(4), qualifyAttribute(new AttributeTrail('a'), 'b'))
        ),
        other: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), true)),
        out: true,
      },
      {
        unk: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), true)),
  ...
  it('Unknown ids', () => {
    const tests = [
      ...
      {
        unk: new UnknownRefVal(BigInt(2), qualifyAttribute(new AttributeTrail('a'), true)),
        ids: [BigInt(2)],
        attrs: ['a[true]'],
      },
      {
      ...
      {
        unk: new UnknownRefVal(BigInt(4), qualifyAttribute(new AttributeTrail('a'), 'c')),
        ids: [BigInt(4)],
        attrs: ['a.c'],
      },
      {
    ...
    for (const test of tests) {
      ...
      expect(test.unk!.attributeTrails().flatMap((e) => e[1].map((v) => v.toString()))).toEqual(
        test.attrs
      );
    }
  });
  ...
  it('Unknown string', () => {
    const tests = [
      ...
      {
        unk: new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), false)),
        out: 'a[false] (3)',
      },
      {
        unk: mergeUnknowns(
      ...
      },
      {
        ...
        unk: mergeUnknowns(
          new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 0)),
          new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 0))
        ),
        out: 'a[0] (3)',
      },
      {
        ...
        unk: mergeUnknowns(
          new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 0)),
          new UnknownRefVal(BigInt(3), qualifyAttribute(new AttributeTrail('a'), 1))
        ),
        out: '[a[0] a[1]] (3)',
      },
    ];
