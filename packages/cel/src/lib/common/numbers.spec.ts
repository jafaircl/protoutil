...
describe('numbers', () => {
  ...
  it('int64', () => {
    ...
    expect(int64('9223372036854775807').value).toEqual(BigInt('9223372036854775807'));
    expect(int64(-9223372036854775808).value).toEqual(BigInt('-9223372036854775808'));
    ...
    expect(int64(BigInt('9223372036854775807')).value).toEqual(BigInt('9223372036854775807'));
    expect(int64(BigInt('-9223372036854775808')).value).toEqual(BigInt('-9223372036854775808'));
    ...
    expect(int64(int64('9223372036854775807')).value).toEqual(BigInt('9223372036854775807'));
    expect(int64(int64('-9223372036854775808')).value).toEqual(BigInt('-9223372036854775808'));

    // Constructor with Uint64
    expect(int64(uint64(0)).value).toEqual(BigInt(0));
    expect(int64(uint64('9223372036854775807')).value).toEqual(BigInt('9223372036854775807'));
  });
  ...
  it('uint64', () => {
    ...
    expect(uint64('18446744073709551615').value).toEqual(BigInt('18446744073709551615'));
    ...
    expect(uint64(BigInt('18446744073709551615')).value).toEqual(BigInt('18446744073709551615'));
    expect(() => uint64(BigInt('18446744073709551616'))).toThrow();

    // Constructor with Int64
    expect(uint64(int64(0)).value).toEqual(BigInt(0));
    expect(uint64(int64('9223372036854775807')).value).toEqual(BigInt('9223372036854775807'));

    // Constructor with Uint64
    expect(uint64(uint64(0)).value).toEqual(BigInt(0));
    expect(uint64(uint64('18446744073709551615')).value).toEqual(BigInt('18446744073709551615'));
