...
export function isBoolProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'primitive' && type.typeKind.value === Type_PrimitiveType.BOOL;
}
...
export function isBytesProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'primitive' && type.typeKind.value === Type_PrimitiveType.BYTES;
}
...
export function isDoubleProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'primitive' && type.typeKind.value === Type_PrimitiveType.DOUBLE;
}
...
export function isIntProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'primitive' && type.typeKind.value === Type_PrimitiveType.INT64;
}
...
export function isStringProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'primitive' && type.typeKind.value === Type_PrimitiveType.STRING;
}
...
export function isUintProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'primitive' && type.typeKind.value === Type_PrimitiveType.UINT64;
}
...
export function isAnyProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'wellKnown' && type.typeKind.value === Type_WellKnownType.ANY;
}

/**
 * DurationProtoType represents a 'google.protobuf.Duration' protobuf CEL type.
 */
export const DurationProtoType = newWellKnownProtoType(Type_WellKnownType.DURATION);
...
export function isDurationProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'wellKnown' && type.typeKind.value === Type_WellKnownType.DURATION;
}
 ...
 * type.
 */
export const TimestampProtoType = newWellKnownProtoType(Type_WellKnownType.TIMESTAMP);
...
export function isTimestampProtoType(type: Type): type is Type & {
  ...
  return type.typeKind.case === 'wellKnown' && type.typeKind.value === Type_WellKnownType.TIMESTAMP;
}
