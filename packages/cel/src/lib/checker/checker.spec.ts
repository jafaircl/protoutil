...
import { Container, name as containerName } from '../common/container.js';
import {
  FunctionDecl,
  memberOverload,
  newFunction,
...
import { OptionalType } from '../common/types/optional.js';
...
import { CheckerEnvOptions, Env } from './env.js';
...
~bool^equals`,
    ...
    },
    {
      ...
      container: 'cel.expr.conformance.proto3',
      env: {
        idents: [newVariableDecl('x', newObjectType('cel.expr.conformance.proto3.Proto2Message'))],
      },
      err: `
...
`,
    },
    {
      ...
      container: 'cel.expr.conformance.proto3',
      env: {
        idents: [newVariableDecl('x', newObjectType('cel.expr.conformance.proto3.TestAllTypes'))],
      },
      out: `_==_(
        _+_(
    ...
    },
    {
      ...
      env: {
        idents: [
          newVariableDecl(
            'x',
            newListType(newObjectType('cel.expr.conformance.proto3.TestAllTypes'))
          ),
    ...
    },
    {
      ...
      env: {
        idents: [
          newVariableDecl(
            'x',
            newMapType(StringType, newObjectType('cel.expr.conformance.proto3.TestAllTypes'))
          ),
        ],
      },
      err: `
...
| .........^
    ...
    ^cel.expr.conformance.proto3.TestAllTypes`,
      outType: newTypeTypeWithParam(newObjectType('cel.expr.conformance.proto3.TestAllTypes')),
    },
    {
...
| ....^`,
        ...
        functions: [
          new FunctionDecl({
            ...
            overloads: [
              new OverloadDecl({
                id: 'size_message',
                argTypes: [newObjectType('cel.expr.conformance.proto3.TestAllTypes')],
                resultType: IntType,
              }),
            ],
          }),
    ...
    },
    {
      ...
      env: {
        idents: [
          newVariableDecl('x', newObjectType('cel.expr.conformance.proto3.TestAllTypes')),
    ...
    && !has(pb3.map_string_string)`,
      env: {
        idents: [
          newVariableDecl('pb2', newObjectType('cel.expr.conformance.proto2.TestAllTypes')),
          newVariableDecl('pb3', newObjectType('cel.expr.conformance.proto3.TestAllTypes')),
        ],
      },
      out: `
    _&&_(
    ...
    ~list(cel.expr.conformance.proto2.TestAllTypes.NestedMessage)`,
      outType: newListType(newObjectType('cel.expr.conformance.proto2.TestAllTypes.NestedMessage')),
    },
    {
      in: `TestAllTypes{}.repeated_nested_message`,
      container: 'cel.expr.conformance.proto3',
    ...
    ~list(cel.expr.conformance.proto3.TestAllTypes.NestedMessage)`,
      outType: newListType(newObjectType('cel.expr.conformance.proto3.TestAllTypes.NestedMessage')),
    },
    {
    ...
    _==_(
      ...
      env: {
        idents: [newVariableDecl('x', newOpaqueType('set', newTypeParamType('T')))],
        functions: [
          new FunctionDecl({
            name: 'set',
            overloads: [
    ...
    },
    {
      ...
      env: {
        idents: [newVariableDecl('values', newListType(newMapType(StringType, StringType)))],
      },
      out: `__comprehension__(
        // Variable
        i,
    ...
    },
    {
      in: `a.b`,
      env: {
        idents: [newVariableDecl('a', newOptionalType(newMapType(StringType, StringType)))],
      },
      outType: newOptionalType(StringType),
    ...
    },
    {
      ...
      env: {
        optionalSyntax: true,
        idents: [newVariableDecl('a', newOptionalType(newMapType(StringType, DynType)))],
      },
      outType: BoolType,
      out: `_?._(
    ...
    },
    {
      ...
      env: {
        idents: [
          ...
          newVariableDecl(
            'null_msg',
            newNullableType(newObjectType('cel.expr.conformance.proto2.TestAllTypes'))
          ),
        ],
      },
      outType: BoolType,
  ...
  for (const tc of testCases) {
    it(`should check ${tc.in}`, () => {
      ...
      if (tcParser.errors.length() > 0) {
        throw new Error(`Unexpected parse errors: ${tcParser.errors.toDisplayString()}`);
      }
      ...
      if (checker.errors.length() > 0) {
        if (tc.err) {
          ...
          throw new Error(`Unexpected check errors: ${checker.errors.toDisplayString()}`);
        }
      }
