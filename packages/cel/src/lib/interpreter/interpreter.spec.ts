...
import { abbrevs, Container, name as containerName } from '../common/container.js';
import { FunctionDecl, newVariableDecl, OverloadDecl, VariableDecl } from '../common/decls.js';
import { Overload } from '../common/functions.js';
import { newStringProtoExpr } from '../common/pb/expressions.js';
...
import { DynamicList } from '../common/types/list.js';
...
import { isStringRefVal, StringRefVal } from '../common/types/string.js';
import { timestampFromSeconds } from '../common/types/timestamp.js';
import { Adder } from '../common/types/traits/math.js';
...
import { isNil, objectToMap } from '../common/utils.js';
...
import { AttrFactory, AttributeFactory, enableErrorOnBadPresenceTest } from './attributes.js';
...
describe('interpreter', () => {
  const testCases: TestCase[] = [
    ...
    },
    {
      ...
      expr: `m[(x ? 0 : 1)] >= 0`,
      vars: [newVariableDecl('m', newListType(IntType)), newVariableDecl('x', BoolType)],
      in: objectToMap({
        m: [BigInt(-1)],
        x: false,
      }),
    ...
    },
    {
      ...
      out: create(TestAllTypesSchema, {
        ...
        repeatedInt32: [TestAllTypes_NestedEnum.FOO, TestAllTypes_NestedEnum.BAZ],
      }),
    },
    {
    ...
    },
    {
      ...
      vars: [newVariableDecl('code', StringType), newVariableDecl('tags', newListType(StringType))],
      in: objectToMap({
        code: '222',
        tags: ['a', 'b'],
      }),
    ...
    // },
    {
      ...
      vars: [newVariableDecl('pb3', newObjectType('cel.expr.conformance.proto3.TestAllTypes'))],
      in: objectToMap({
    ...
    // Wrapper type nil or value test.
    {
      ...
      vars: [newVariableDecl('a', newObjectType('cel.expr.conformance.proto3.TestAllTypes'))],
      in: objectToMap({
